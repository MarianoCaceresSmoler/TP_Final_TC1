...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \begin{circuitikz}[american, scale=0.82, transform shape]
            \draw (0,0) node[ground]{} to[sV,l=$v_i$] (0,2.5) to[R,l=$R$] (2,2.5) to[L,l=$L$] (4,2.5) to[C,l=$C$] (4,0) node[ground]{};
            \draw (4,2.5) to[open,v^=$v_o$] (4,0);
        \end{circuitikz}
        \caption{Circuito 2.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \begin{circuitikz}[american, scale=0.82, transform shape]
            \draw (0,0) node[ground]{} to[sV,l=$v_i$] (0,2.5) to[R,l=$R$] (2,2.5) to[C,l=$C$] (4,2.5) to[L,l=$L$] (4,0) node[ground]{};
            \draw (4,2.5) to[open,v^=$v_o$] (4,0);
        \end{circuitikz}
        \caption{Circuito 3.}
    \end{subfigure}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \begin{circuitikz}[american, scale=0.82, transform shape]
            \draw (0,0) node[ground]{} to[sV,l=$v_i$] (0,2.5) to[L,l=$L$] (2,2.5) to[C,l=$C$] (4,2.5) to[R,l=$R$] (4,0) node[ground]{};
            \draw (4,2.5) to[open,v^=$v_o$] (4,0);
        \end{circuitikz}
        \caption{Circuito 4.}
    \end{subfigure}
